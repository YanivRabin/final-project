...
exports.createWorkoutPlan = [
    ...
    (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            yield workout_model_1.default.deleteOne({ email: email });
...
exports.updateWorkoutPlan = [
    ...
    (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const existingWorkoutPlan = yield workout_model_1.default.findOne({ email });
            ...
            const workoutPlan = new workout_model_1.default(updatedWorkoutPlan);
            yield workoutPlan.save();
